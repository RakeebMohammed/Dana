...
export default function DashboardClient({ admin, visits, leads }: { admin: string; visits: Visit[]; leads: Lead[] }) {
  ...
  return <main className="dashboard-shell">
    <header className="dashboard-topbar"><div><p className="eyebrow">POPIN / CONTROL ROOM</p><h1>Good to see you, {admin}.</h1><p className="subtle">A live view of verified visitors and new conversations.</p></div><form action="/api/admin/logout" method="post"><button className="logout-button">Log out</button></form></header>
